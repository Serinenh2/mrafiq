...
from .views import (DomainViewSet, LegalReferenceViewSet, RequirementViewSet,
                    ...
                    ValidationCheckView, DeclarationPdfView, CompanyProfilePdfView,
                    ActionsXlsxView, CartographieXlsxView, AssistantView, DashboardView)
...
urlpatterns = [
    ...
    path('companies/<int:company_id>/export/fiche-entreprise.pdf', CompanyProfilePdfView.as_view()),
    path('companies/<int:company_id>/export/plan-action.xlsx', ActionsXlsxView.as_view()),
    path('companies/<int:company_id>/export/cartographie.xlsx', CartographieXlsxView.as_view()),
